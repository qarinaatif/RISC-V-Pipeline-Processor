...
RISCOF = os.path.dirname(
    os.path.abspath(__file__)
)

class nrv(pluginTemplate):
    __model__ = "nrv"
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for nrv start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
      ...
      self.sbt = "sbt 'runMain pipeline.NRVDriver {0} {1} --target-dir out/{2}'"
    ...
    def runTests(self, testList):
      ...
      for testname in testList:
        ...
        #   print(f"{os.path.join(testentry['work_dir'], 'imem.hex') = }")
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = '; '.join((
                ...
                f'riscv32-unknown-elf-objdump -d -Mno-aliases {elf} > {test_dir}/my.elf.objdump',
                f'cd {self.dut}',
                self.sbt.format(
                    os.path.join(testentry['work_dir'], 'imem.hex'),
                    os.path.join(testentry['work_dir'], 'dmem.hex'),
